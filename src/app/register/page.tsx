...
export default function RegisterPage() {
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white overflow-x-hidden">
      ...
      >
        <h1 className="text-3xl font-extrabold mb-6 text-purple-200 drop-shadow-lg text-center">Register</h1>
        <AnimatePresence>
          {error && (
            <motion.p
        ...
        <p className="mt-6 text-center text-gray-300">
          ...
          <a href="/signin" className="text-purple-400 hover:underline font-semibold">
            Sign In
          </a>
        </p>
      </form>
